        ...
        <div class="row" data-aos="fade-up" data-aos-delay="100">
          <div class="col-lg-12 d-flex justify-content-center">
            <ul class="menu-filters isotope-filters">
              ...
              <li data-filter=".filter-active">Esspresso Based</li>
        ...
        <div class="row isotope-container" data-aos="fade-up" data-aos-delay="200">
          ...
          <div class="col-lg-6 menu-item isotope-item filter-starters">
            ...
            <div class="menu-content">
              <a href="#">Wedang Lakmana</a><span>12K</span>
            </div>
          ...
          <div class="col-lg-6 menu-item isotope-item filter-salads">
            ...
            <div class="menu-content">
              <a href="#">Kampul Gendari</a><span>7K</span>
            </div>
            <div class="menu-ingredients">
              Kombinasi Teh racikan dan Jeruk
            </div>
          </div><!-- Menu Item -->
      ...
      <div class="container" data-aos="fade-up" data-aos-delay="100">
        ...
        <form action="forms/book-a-table.php" method="post" role="form" class="php-email-form">
          <div class="row gy-4">
            ...
            <div class="col-lg-4 col-md-6">
              <input type="text" name="name" class="form-control" id="name" placeholder="Ruangan" required="">
            </div>
            <div class="col-lg-4 col-md-6">
              <input type="text" name="name" class="form-control" id="name" placeholder="Setup Meja" required="">
            </div>
            <div class="col-lg-4 col-md-6">
              <input type="text" name="name" class="form-control" id="name" placeholder="Fasilitas" required="">
            </div>
          </div>

          <div class="form-group mt-3">
            <textarea class="form-control" name="Tambahan Informasi" rows="5" placeholder="Tambahan Informasi"></textarea>
          </div>
